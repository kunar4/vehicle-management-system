...
<head>
    ...
    <script>
        // Function to redirect to the update form
        function redirectToUpdateForm() {
            // Replace with the actual URL of your update form
            window.location.href = 'update_user_details_form.php';
        }
    </script>
</head>
<body>
    <div class="header">
        <span id="kebab-menu" class="kebab-menu">&#9776;</span>
        <div id="menu" class="menu">
            <div id="user-details"></div>
            <div class="menu-links">
                <a href="citizen-home.php">Back to Citizen Home</a>
                <a href="#">Logout</a>
            </div>
        </div>
    </div>
    ...
    <?php
    session_start();
    var_dump($_SESSION['user_id']); // Check the value
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if ($result) {
            if ($result->num_rows > 0) {
                ...
                echo "<button class='update-details-btn' onclick='redirectToUpdateForm()'>Update Details</button>";
                echo "</div>";
            } else {
                echo "<div class='box'>";
                echo "<h1>User Data</h1>";
            ...
            echo "<div class='box'>";
            echo "<h1>User Data</h1>";
            echo "<p>Error fetching user data: " . $conn->error . "</p>";
            echo "</div>";
        }
    } else {
        echo "<div class='box'>";
